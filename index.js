...
const thumbnailUrl = "https://files.catbox.moe/iq9iaa.jpg";
...
async function mainMenu(ctx) {
  ...
  const text = `
<blockquote>
<strong>ハローハウ ${name}</strong>, 私はあなたを助けることができるロボットです。できるだけ私を活用してください。

╭═───⊱ <strong>𝗕 𝗟 𝗔 𝗖 𝗞 𝗢 𝗥 𝗜 𝗢 𝗡</strong> ───═⬡
│ ⸙ <strong>Developer:</strong> @RidzzOffc
│ ⸙ <strong>Version:</strong> 3.0 Private
│ ⸙ <strong>Prefix:</strong> / (slash)
│ ⸙ <strong>Framework:</strong> Telegraf
│ ⸙ <strong>Language:</strong> JavaScript
╰═─────────────═⬡

╭═───⊱ <strong>BOT STATUS</strong> ───═⬡
│ ⸙ <strong>Sender:</strong> ${sender}
│ ⸙ <strong>Runtime:</strong> ${uptime}
│ ⸙ <strong>Memory:</strong> ${memory}
│ ⸙ <strong>Cooldown:</strong> ${cooldown}s
╰═─────────────═⬡
</blockquote>
`;
  ...
  const keyboard = Markup.inlineKeyboard([
    [
      Markup.button.callback("𝗕𝗨𝗚 𖠂 𝗠𝗘𝗡𝗨", "bugmenu"),
      Markup.button.callback("𝗢𝗪𝗡𝗘𝗥 𖠂 𝗠𝗘𝗡𝗨", "ownermenu")
    ],
    [
      Markup.button.callback("𝗧𝗢𝗢𝗟𝗦 𖠂 𝗠𝗘𝗡𝗨", "toolsmenu"),
      Markup.button.callback("𝗧𝗛𝗔𝗡𝗞𝗦 𖠂 𝗧𝗢", "thanksto")
    ],
    [
      Markup.button.url("𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗧𝗜𝗢𝗡 𝗦𝗖𝗥𝗜𝗣𝗧", "https://t.me/ghostStrm"),
      Markup.button.url("𝗘𝗠𝗣𝗘𝗥𝗢𝗥", "https://t.me/RidzzOffc")
    ]
  ]);
...
│ ⸙ <strong>Runtime:</strong> ${uptime}
│ ⸙ <strong>Memory:</strong> ${memory}
│ ⸙ <strong>Cooldown:</strong> ${COOLDOWN_TIME / 1000}s
╰═─────────────═⬡

╭═───⊱ <strong>BUGS MENU</strong> ───═⬡
│ ⸙ /xmurbug
│ ᯓ➤ Forclose Bebas Spam
│ ⸙ /Xdelay
│ ᯓ➤ Invisible
│ ⸙ /Xios
│ ᯓ➤ Invisible Crash IOS
│ ⸙ /Xxblank
│ ᯓ➤ Blank Hard
│ ⸙ /delaySpm
│ ᯓ➤ delay spam for murbug 
╰═─────────────═⬡
</blockquote>
`
  ...
  await ctx.editMessageMedia(
    {
      type: "photo",
      media: { source: "./image/BlackOrionGw.jpg" },
      caption: text,
      parse_mode: "HTML"
    },
    {
      reply_markup: Markup.inlineKeyboard([
        [Markup.button.callback("Back - Menu !", "mainmenu")]
      ]).reply_markup
    }
  )
})
...
│ ᯓ➤ Check Bot Runtime
│ ⸙ /antifoto on/off
│ ᯓ➤ Block Photo In Group
│ ⸙ /antivideo on/off
│ ᯓ➤ Block Video In Group
╰═─────────────═⬡
</blockquote>
`
...
│ ⸙ /convert
│ ᯓ➤ Change Photo/Video To URL
│ ⸙ /waktu
│ ᯓ➤ Check The Time
│ ⸙ /brat
│ ᯓ➤ Text Stickers
│ ⸙ /tiktokdl
│ ᯓ➤ Download TikTok WM Videos
│ ⸙ /cekidch
│ ᯓ➤ Check Telegram Channel ID
│ ⸙ /ssiphone
│ ᯓ➤ iPhone Screenshot Style
╰═─────────────═⬡
</blockquote>
`
...
bot.action("thanksto", async (ctx) => {
  try {
    ...
    const name = ctx.from?.first_name || "User";
    const sender = typeof isWhatsAppConnected !== "undefined"
      ? (isWhatsAppConnected ? "1 Connected" : "0 Connected")
      : "0 Connected";

    const uptime = typeof runtime !== "undefined"
      ? runtime(process.uptime())
      : process.uptime().toFixed(0) + "s";

    const memory = (process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2) + " MB";

    const cooldown = typeof COOLDOWN_TIME !== "undefined"
      ? COOLDOWN_TIME / 1000
      : 0;
...
╭═───⊱ <strong>THANKS TOO</strong> ───═⬡
│ ⸙ @RidzzOffc - Creator
│ ⸙ @xwarxxx - Best Support
│ ⸙ @MarzzOfficial1 - Frend
│ ⸙ @pherine - Support
│ ⸙ @Zabkanaeru - My Babu
│ ⸙ All Support RidzzOffc
│ ⸙ All Team BLACK ORION
╰═─────────────═⬡
</blockquote>
`;
    ...
    await ctx.editMessageCaption(text, {
      ...
      reply_markup: {
        inline_keyboard: [
          [{ text: "Back - Menu !", callback_data: "mainmenu" }]
        ]
      }
    });
...
bot.action("mainmenu", async (ctx) => {
  try {
    ...
    console.log("Main menu error:", err.message);
  }
});
/// ------ ( Plugins ) ------- \\\
...
bot.command("connect", checkOwner, async (ctx) => {
  try {
    ...
    const msg = await ctx.replyWithPhoto(
      "https://files.catbox.moe/iq9iaa.jpg",
      {
        caption:
`<blockquote>𝑺𝒄𝒂𝒓𝒍𝒆𝒕 𝑪𝒓𝒖𝒔𝒉𝒆𝒓</blockquote>
...
bot.command("Xdelay", checkWhatsAppConnection, checkPremium, checkCooldown, async (ctx) => {
  ...
  const processMessage = await ctx.telegram.sendPhoto(
    ...
    {
      caption: `
<blockquote><pre>𝐒𝐜𝐚𝐫𝐥𝐞𝐭 𝐌𝐞𝐧𝐲𝐞𝐫𝐚𝐧𝐠</pre></blockquote>
⌑ Target : ${q}
...
///============== ( Case bug 3 ) ==========\\
bot.command("Xforce", checkWhatsAppConnection, checkPremium, checkCooldown, async (ctx) => {
  const q = ctx.message.text.split(" ")[1];
...
/// ============= CASE BUG 5 =============\\\
bot.command("delaySpm", checkPremium, checkCooldown, checkWhatsAppConnection, async (ctx) => {
